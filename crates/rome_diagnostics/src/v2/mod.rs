...
pub use advice::{
    CommandAdvice, DiffAdvice, FrameAdvice, IntoAdvices, LogAdvice, LogCategory, Visitor,
};
...
pub use location::{FileId, FilePath, Location, Path, SourceCode};
...
pub mod prelude {
    ...
    pub use super::advice::{IntoAdvices as _, Visitor as _};
