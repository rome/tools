...
impl CssSyntaxKind {
    pub const fn is_punct(self) -> bool {
        match self {
            ...
            | L_ANGLE | R_ANGLE | TILDE | HASH | AMP | PIPE | PLUS | PLUS2 | STAR | STAR2
            | SLASH | CARET | PERCENT | DOT | COLON | EQ | EQ2 | BANG | NEQ | MINUS | MINUS2
            | LTEQ | GTEQ | PLUSEQ | MINUSEQ | PIPEEQ | AMPEQ | CARETEQ | SLASHEQ | STAREQ
            | PERCENTEQ | AMP2 | PIPE2 | AT | DOLLAR_EQ | TILDE_EQ => true,
            _ => false,
        }
    }
