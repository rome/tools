...
use crate::{JsLanguage, JsSyntaxNode, JsSyntaxToken};
use rome_rowan::AstNode;

/// Extensions to rowan's SyntaxNode
pub trait SyntaxNodeExt {
    #[doc(hidden)]
    fn to_node(&self) -> &JsSyntaxNode;
...
impl SyntaxNodeExt for JsSyntaxNode {
    fn to_node(&self) -> &JsSyntaxNode {
        self
    }
}
...
pub fn concat_tokens(tokens: &[JsSyntaxToken]) -> String {
    tokens
        .iter()
