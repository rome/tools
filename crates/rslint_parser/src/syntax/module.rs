...
use crate::syntax::typescript::{
    parse_ts_decorated_statement, parse_ts_enum_declaration,
    parse_ts_import_equals_declaration_rest, parse_ts_interface_declaration,
};
...
fn parse_module_item(p: &mut Parser) -> ParsedSyntax {
    match p.cur() {
        ...
        T![@] => parse_ts_decorated_statement(p, true),
