...
impl IfStmt {
	...
	pub fn condition(&self) -> SyntaxResult<Condition> {
		support::as_mandatory_node(&self.syntax)
	}
...
impl ContinueStmt {
	...
	pub fn name_ref(&self) -> SyntaxResult<NameRef> {
		support::as_mandatory_node(&self.syntax)
	}
	pub fn semicolon_token(&self) -> Option<SyntaxToken> {
		support::as_optional_token(&self.syntax, T ! [;])
...
impl LabelledStmt {
	pub fn label(&self) -> SyntaxResult<Name> {
		support::as_mandatory_node(&self.syntax)
	}
	pub fn colon_token(&self) -> SyntaxResult<SyntaxToken> {
		support::as_mandatory_token(&self.syntax, T ! [:])
	}
	pub fn stmt(&self) -> SyntaxResult<JsAnyStatement> {
		support::as_mandatory_node(&self.syntax)
	}
}
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
...
impl SwitchStmt {
	...
	pub fn test(&self) -> SyntaxResult<Condition> {
		support::as_mandatory_node(&self.syntax)
	}
	pub fn l_curly_token(&self) -> SyntaxResult<SyntaxToken> {
		support::as_mandatory_token(&self.syntax, T!['{'])
...
impl ExportDecl {
	...
	pub fn decl(&self) -> SyntaxResult<Decl> {
		support::as_mandatory_node(&self.syntax)
	}
}
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
...
impl CaseClause {
	...
	pub fn cons(&self) -> AstNodeList<JsAnyStatement> {
		support::node_list(&self.syntax, 0usize)
	}
}
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
...
impl CatchClause {
	...
	pub fn error(&self) -> SyntaxResult<Pattern> {
		support::as_mandatory_node(&self.syntax)
	}
	pub fn r_paren_token(&self) -> SyntaxResult<SyntaxToken> {
		support::as_mandatory_token(&self.syntax, T![')'])
...
impl DotExpr {
	...
	pub fn prop(&self) -> SyntaxResult<Name> {
		support::as_mandatory_node(&self.syntax)
	}
}
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
...
impl SequenceExpr {
	...
	pub fn bin_expr(&self) -> SyntaxResult<BinExpr> {
		support::as_mandatory_node(&self.syntax)
	}
}
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
...
impl FnExpr {
	...
	pub fn parameters(&self) -> SyntaxResult<ArgList> {
		support::as_mandatory_node(&self.syntax)
	}
	pub fn colon_token(&self) -> Option<SyntaxToken> {
		support::as_optional_token(&self.syntax, T ! [:])
...
impl ClassExpr {
	...
	pub fn parent(&self) -> Option<JsAnyExpression> {
		support::as_optional_node(&self.syntax)
	}
	...
	pub fn body(&self) -> SyntaxResult<ClassBody> {
		support::as_mandatory_node(&self.syntax)
	}
}
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
...
impl PrivatePropAccess {
	pub fn lhs(&self) -> SyntaxResult<JsAnyExpression> {
		support::as_mandatory_node(&self.syntax)
	}
	pub fn dot_token(&self) -> SyntaxResult<SyntaxToken> {
		support::as_mandatory_token(&self.syntax, T ! [.])
	}
	pub fn rhs(&self) -> SyntaxResult<PrivateName> {
		support::as_mandatory_node(&self.syntax)
	}
}
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
...
impl Method {
	...
	pub fn name(&self) -> SyntaxResult<PropName> {
		support::as_mandatory_node(&self.syntax)
	}
	pub fn type_params(&self) -> Option<TsTypeParams> {
		support::as_optional_node(&self.syntax)
...
impl PrivateProp {
	pub fn class_prop(&self) -> SyntaxResult<ClassProp> {
		support::as_mandatory_node(&self.syntax)
	}
}
#[derive(Debug, Clone, PartialEq, Eq, Hash)]
...
impl ClassProp {
	...
	pub fn value(&self) -> Option<JsAnyExpression> {
		support::as_optional_node(&self.syntax)
	}
	pub fn semicolon_token(&self) -> Option<SyntaxToken> {
		support::as_optional_token(&self.syntax, T ! [;])
...
impl ClassDecl {
	...
	pub fn parent(&self) -> SyntaxResult<NameRef> {
		support::as_mandatory_node(&self.syntax)
	}
	pub fn body(&self) -> SyntaxResult<ClassBody> {
		support::as_mandatory_node(&self.syntax)
...
impl Declarator {
	pub fn pattern(&self) -> SyntaxResult<Pattern> {
		support::as_mandatory_node(&self.syntax)
	}
	pub fn excl_token(&self) -> SyntaxResult<SyntaxToken> {
		support::as_mandatory_token(&self.syntax, T![!])
...
impl TsFnType {
	pub fn params(&self) -> SyntaxResult<ParameterList> {
		support::as_mandatory_node(&self.syntax)
	}
	pub fn fat_arrow_token(&self) -> SyntaxResult<SyntaxToken> {
		support::as_mandatory_token(&self.syntax, T ! [=>])
...
impl From<EmptyStmt> for JsAnyStatement {
	fn from(node: EmptyStmt) -> JsAnyStatement {
		JsAnyStatement::EmptyStmt(node)
	}
}
impl From<ExprStmt> for JsAnyStatement {
	fn from(node: ExprStmt) -> JsAnyStatement {
		JsAnyStatement::ExprStmt(node)
	}
}
impl From<IfStmt> for JsAnyStatement {
	fn from(node: IfStmt) -> JsAnyStatement {
		JsAnyStatement::IfStmt(node)
	}
}
impl From<DoWhileStmt> for JsAnyStatement {
	fn from(node: DoWhileStmt) -> JsAnyStatement {
		JsAnyStatement::DoWhileStmt(node)
	}
}
impl From<WhileStmt> for JsAnyStatement {
	fn from(node: WhileStmt) -> JsAnyStatement {
		JsAnyStatement::WhileStmt(node)
	}
}
...
impl From<ContinueStmt> for JsAnyStatement {
	fn from(node: ContinueStmt) -> JsAnyStatement {
		JsAnyStatement::ContinueStmt(node)
	}
}
impl From<BreakStmt> for JsAnyStatement {
	fn from(node: BreakStmt) -> JsAnyStatement {
		JsAnyStatement::BreakStmt(node)
	}
}
impl From<ReturnStmt> for JsAnyStatement {
	fn from(node: ReturnStmt) -> JsAnyStatement {
		JsAnyStatement::ReturnStmt(node)
	}
}
impl From<WithStmt> for JsAnyStatement {
	fn from(node: WithStmt) -> JsAnyStatement {
		JsAnyStatement::WithStmt(node)
	}
}
impl From<LabelledStmt> for JsAnyStatement {
	fn from(node: LabelledStmt) -> JsAnyStatement {
		JsAnyStatement::LabelledStmt(node)
	}
}
impl From<SwitchStmt> for JsAnyStatement {
	fn from(node: SwitchStmt) -> JsAnyStatement {
		JsAnyStatement::SwitchStmt(node)
	}
}
impl From<ThrowStmt> for JsAnyStatement {
	fn from(node: ThrowStmt) -> JsAnyStatement {
		JsAnyStatement::ThrowStmt(node)
	}
}
impl From<TryStmt> for JsAnyStatement {
	fn from(node: TryStmt) -> JsAnyStatement {
		JsAnyStatement::TryStmt(node)
	}
}
impl From<DebuggerStmt> for JsAnyStatement {
	fn from(node: DebuggerStmt) -> JsAnyStatement {
		JsAnyStatement::DebuggerStmt(node)
	}
}
...
impl From<ArrowExpr> for JsAnyExpression {
	fn from(node: ArrowExpr) -> JsAnyExpression {
		JsAnyExpression::ArrowExpr(node)
	}
}
impl From<Literal> for JsAnyExpression {
	fn from(node: Literal) -> JsAnyExpression {
		JsAnyExpression::Literal(node)
	}
}
...
impl From<NameRef> for JsAnyExpression {
	fn from(node: NameRef) -> JsAnyExpression {
		JsAnyExpression::NameRef(node)
	}
}
impl From<ThisExpr> for JsAnyExpression {
	fn from(node: ThisExpr) -> JsAnyExpression {
		JsAnyExpression::ThisExpr(node)
	}
}
impl From<ArrayExpr> for JsAnyExpression {
	fn from(node: ArrayExpr) -> JsAnyExpression {
		JsAnyExpression::ArrayExpr(node)
	}
}
impl From<ObjectExpr> for JsAnyExpression {
	fn from(node: ObjectExpr) -> JsAnyExpression {
		JsAnyExpression::ObjectExpr(node)
	}
}
impl From<GroupingExpr> for JsAnyExpression {
	fn from(node: GroupingExpr) -> JsAnyExpression {
		JsAnyExpression::GroupingExpr(node)
	}
}
impl From<BracketExpr> for JsAnyExpression {
	fn from(node: BracketExpr) -> JsAnyExpression {
		JsAnyExpression::BracketExpr(node)
	}
}
impl From<DotExpr> for JsAnyExpression {
	fn from(node: DotExpr) -> JsAnyExpression {
		JsAnyExpression::DotExpr(node)
	}
}
...
impl From<UnaryExpr> for JsAnyExpression {
	fn from(node: UnaryExpr) -> JsAnyExpression {
		JsAnyExpression::UnaryExpr(node)
	}
}
...
impl From<BinExpr> for JsAnyExpression {
	fn from(node: BinExpr) -> JsAnyExpression {
		JsAnyExpression::BinExpr(node)
	}
}
impl From<CondExpr> for JsAnyExpression {
	fn from(node: CondExpr) -> JsAnyExpression {
		JsAnyExpression::CondExpr(node)
	}
}
...
impl From<SequenceExpr> for JsAnyExpression {
	fn from(node: SequenceExpr) -> JsAnyExpression {
		JsAnyExpression::SequenceExpr(node)
	}
}
impl From<FnExpr> for JsAnyExpression {
	fn from(node: FnExpr) -> JsAnyExpression {
		JsAnyExpression::FnExpr(node)
	}
}
impl From<ClassExpr> for JsAnyExpression {
	fn from(node: ClassExpr) -> JsAnyExpression {
		JsAnyExpression::ClassExpr(node)
	}
}
...
impl From<SuperCall> for JsAnyExpression {
	fn from(node: SuperCall) -> JsAnyExpression {
		JsAnyExpression::SuperCall(node)
	}
}
impl From<ImportCall> for JsAnyExpression {
	fn from(node: ImportCall) -> JsAnyExpression {
		JsAnyExpression::ImportCall(node)
	}
}
impl From<YieldExpr> for JsAnyExpression {
	fn from(node: YieldExpr) -> JsAnyExpression {
		JsAnyExpression::YieldExpr(node)
	}
}
impl From<AwaitExpr> for JsAnyExpression {
	fn from(node: AwaitExpr) -> JsAnyExpression {
		JsAnyExpression::AwaitExpr(node)
	}
}
impl From<PrivatePropAccess> for JsAnyExpression {
	fn from(node: PrivatePropAccess) -> JsAnyExpression {
		JsAnyExpression::PrivatePropAccess(node)
	}
}
...
impl From<JsBlockStatement> for ExprOrBlock {
	fn from(node: JsBlockStatement) -> ExprOrBlock {
		ExprOrBlock::JsBlockStatement(node)
	}
}
...
impl From<JsUnknownMember> for ObjectProp {
	fn from(node: JsUnknownMember) -> ObjectProp {
		ObjectProp::JsUnknownMember(node)
	}
}
...
impl From<JsUnknownMember> for ClassElement {
	fn from(node: JsUnknownMember) -> ClassElement {
		ClassElement::JsUnknownMember(node)
	}
}
...
impl From<ComputedPropertyName> for PropName {
	fn from(node: ComputedPropertyName) -> PropName {
		PropName::ComputedPropertyName(node)
	}
}
impl From<Literal> for PropName {
	fn from(node: Literal) -> PropName {
		PropName::Literal(node)
	}
}
...
impl From<SpreadElement> for ExprOrSpread {
	fn from(node: SpreadElement) -> ExprOrSpread {
