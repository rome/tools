...
pub fn ts_index_signature_identifier_binding(
    name_token: SyntaxToken,
) -> TsIndexSignatureIdentifierBinding {
    TsIndexSignatureIdentifierBinding::unwrap_cast(SyntaxNode::new_detached(
        JsSyntaxKind::TS_INDEX_SIGNATURE_IDENTIFIER_BINDING,
        [Some(SyntaxElement::Token(name_token))],
    ))
}
pub fn ts_index_signature_parameter(
    binding: TsIndexSignatureIdentifierBinding,
    type_annotation: TsTypeAnnotation,
