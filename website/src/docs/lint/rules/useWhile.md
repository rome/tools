...
{% raw %}<pre class="language-text"><code class="language-text"><span style="color: Tomato;">error</span><span style="color: Tomato;">[</span><span style="color: Tomato;"><a href="https://rome.tools/docs/lint/rules/useWhile/">correctness/useWhile</a></span><span style="color: Tomato;">]</span><em>: </em><em>Use </em><em><em>while</em></em><em> loops instead of </em><em><em>for</em></em><em> loops.</em>
