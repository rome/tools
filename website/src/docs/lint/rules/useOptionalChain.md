...
{% raw %}<pre class="language-text"><code class="language-text"><span style="color: Tomato;">error</span><span style="color: Tomato;">[</span><span style="color: Tomato;"><a href="https://rome.tools/docs/lint/rules/useOptionalChain/">correctness/useOptionalChain</a></span><span style="color: Tomato;">]</span><em>: </em><em>Change to an optional chain.</em>
  <span style="color: rgb(38, 148, 255);">┌</span><span style="color: rgb(38, 148, 255);">─</span> correctness/useOptionalChain.js:1:1
