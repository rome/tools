...
<!-- EVERYTHING BELOW IS AUTOGENERATED. SEE SCRIPTS FOLDER FOR UPDATE SCRIPTS hash(fd2b2011792dfb11648aa7717c06d1c6f9ec2e1a) -->

## Examples
### Invalid
<pre class="language-text"><code class="language-text"><<span class="token attr-name">span</span> <span class="token attr-name">tabIndex</span><span class="token operator">=</span><span class="token string">&apos;5&apos;</span>>foo<<span class="token operator">/</span><span class="token attr-name">span</span>></code></pre>
...
<pre class="language-text"><code class="language-text"><<span class="token attr-name">span</span> <span class="token attr-name">tabIndex</span><span class="token operator">=</span><span class="token string">&apos;-1&apos;</span>>baz<<span class="token operator">/</span><span class="token attr-name">span</span>></code></pre>
<pre class="language-text"><code class="language-text"><<span class="token attr-name">span</span> <span class="token attr-name">tabIndex</span><span class="token operator">=</span><span class="token string">&apos;0&apos;</span>>baz<<span class="token operator">/</span><span class="token attr-name">span</span>></code></pre>
