...
<!-- GENERATED:START(hash:65b90e8dcbd7070d4c20dcbf593cae8f3e485945,id:examples) Everything below is automatically generated. DO NOT MODIFY. Run `./rome run scripts/generated-files/lint-rules-docs` to update. -->
## Examples
...
{% raw %}<pre class="language-text"><code class="language-text"><span class="token punctuation">&lt;</span><span class="token tag">div</span> <span class="token attr-name">scope</span><span class="token attr-equals">=</span>&apos;col&apos; /&gt;</code></pre>{% endraw %}
{% raw %}<pre class="language-text"><code class="language-text">
 <span style="text-decoration-style: dashed; text-decoration-line: underline;">file.html:1:11</span> <strong>parse(html)</strong> ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  <strong><span style="color: Tomato;">✖ </span></strong><span style="color: Tomato;">The name of the attribute is not valid and should be wrapped in</span>
    ...
    <span class="token punctuation">&lt;</span><span class="token tag">div</span> <span class="token attr-name">scope</span><span class="token attr-equals">=</span>&apos;col&apos; /&gt;
...
{% raw %}<pre class="language-text"><code class="language-text"><span class="token punctuation">&lt;</span><span class="token tag">th</span> <span class="token attr-name">scope</span><span class="token attr-equals">=</span>&apos;col&apos;&gt;<span class="token punctuation">&lt;/</span><span class="token attr-name">th</span><span class="token punctuation">&gt;</span></code></pre>{% endraw %}
