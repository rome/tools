...
<!-- GENERATED:START(hash:de51d34aada9c6b0bd42a929e72001166c1b205b,id:examples) Everything below is automatically generated. DO NOT MODIFY. Run `./rome run scripts/generated-files/lint-rules-docs` to update. -->
## Examples
...
{% raw %}<pre class="language-js"><code class="language-js">&lt;<span class="token variable">p</span> <span class="token attr-name">href</span><span class="token operator">=</span><span class="token string">&quot;http://external.link&quot;</span> <span class="token attr-name">target</span><span class="token operator">=</span><span class="token string">&quot;_blank&quot;</span>&gt;child&lt;<span class="token operator">/</span><span class="token variable">p</span>&gt;</code></pre>{% endraw %}
