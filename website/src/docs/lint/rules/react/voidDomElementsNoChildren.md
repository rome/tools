...
<pre class="language-text"><code class="language-text">React.createElement('img', {children: ''<span class="token variable">child</span><span class="token string">&apos;})</span><strong><span style="background-color: red">child</span></strong></code></pre>
<pre class="language-text"><code class="language-text">
 <span style="text-decoration-style: dotted;">file.tsx:1:40</span> <strong>parse/js</strong> ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

  <strong><span style="color: Tomato;">✖ </span></strong><span style="color: Tomato;">Unexpected token, expected ,</span>

    React.createElement(&apos;img&apos;, {children: &apos;&apos;<span class="token variable">child</span><span class="token string">&apos;})</span><strong><span style="background-color: red">child</span></strong>
...
<pre class="language-text"><code class="language-text">React.createElement('img', {dangerouslySetInnerHTML: {__html: ''<span class="token variable">child</span><span class="token string">&apos;}})</span><strong><span style="background-color: red">child</span></strong></code></pre>
<pre class="language-text"><code class="language-text">
 <span style="text-decoration-style: dotted;">file.tsx:1:64</span> <strong>parse/js</strong> ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

  <strong><span style="color: Tomato;">✖ </span></strong><span style="color: Tomato;">Unexpected token, expected ,</span>

    React.createElement(&apos;img&apos;, {dangerouslySetInnerHTML: {__html: &apos;&apos;<span class="token variable">child</span>
    <span class="token variable">  </span><span class="token string">&apos;}})</span><strong><span style="background-color: red">child</span></strong>
...
<pre class="language-text"><code class="language-text">React.createElement('img', {}, ''<span class="token variable">child</span><span class="token string">&apos;)</span><strong><span style="background-color: red">child</span></strong></code></pre>
<pre class="language-text"><code class="language-text">
 <span style="text-decoration-style: dotted;">file.tsx:1:33</span> <strong>parse/js</strong> ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

  <strong><span style="color: Tomato;">✖ </span></strong><span style="color: Tomato;">Unexpected token, expected ,</span>

    React.createElement(&apos;img&apos;, {}, &apos;&apos;<span class="token variable">child</span><span class="token string">&apos;)</span><strong><span style="background-color: red">child</span></strong>
                                     <span style="color: Tomato;"><strong>^</strong></span><span style="color: Tomato;"><strong>^</strong></span><span style="color: Tomato;"><strong>^</strong></span><span style="color: Tomato;"><strong>^</strong></span><span style="color: Tomato;"><strong>^</strong></span>
...
<pre class="language-text"><code class="language-text">createElement('img', {children: ''<span class="token variable">child</span><span class="token string">&apos;})</span><strong><span style="background-color: red">child</span></strong></code></pre>
<pre class="language-text"><code class="language-text">
 <span style="text-decoration-style: dotted;">file.tsx:1:34</span> <strong>parse/js</strong> ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

  <strong><span style="color: Tomato;">✖ </span></strong><span style="color: Tomato;">Unexpected token, expected ,</span>

    createElement(&apos;img&apos;, {children: &apos;&apos;<span class="token variable">child</span><span class="token string">&apos;})</span><strong><span style="background-color: red">child</span></strong>
                                      <span style="color: Tomato;"><strong>^</strong></span><span style="color: Tomato;"><strong>^</strong></span><span style="color: Tomato;"><strong>^</strong></span><span style="color: Tomato;"><strong>^</strong></span><span style="color: Tomato;"><strong>^</strong></span>
...
<pre class="language-text"><code class="language-text">createElement('img', {dangerouslySetInnerHTML: {__html: ''<span class="token variable">child</span><span class="token string">&apos;}})</span><strong><span style="background-color: red">child</span></strong></code></pre>
<pre class="language-text"><code class="language-text">
 <span style="text-decoration-style: dotted;">file.tsx:1:58</span> <strong>parse/js</strong> ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

  <strong><span style="color: Tomato;">✖ </span></strong><span style="color: Tomato;">Unexpected token, expected ,</span>

    createElement(&apos;img&apos;, {dangerouslySetInnerHTML: {__html: &apos;&apos;<span class="token variable">child</span><span class="token string">&apos;}})</span>
    <strong><span style="background-color: red">child</span></strong>
...
<pre class="language-text"><code class="language-text">createElement('img', {}, ''<span class="token variable">child</span><span class="token string">&apos;)</span><strong><span style="background-color: red">child</span></strong></code></pre>
<pre class="language-text"><code class="language-text">
 <span style="text-decoration-style: dotted;">file.tsx:1:27</span> <strong>parse/js</strong> ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

  <strong><span style="color: Tomato;">✖ </span></strong><span style="color: Tomato;">Unexpected token, expected ,</span>

    createElement(&apos;img&apos;, {}, &apos;&apos;<span class="token variable">child</span><span class="token string">&apos;)</span><strong><span style="background-color: red">child</span></strong>
                               <span style="color: Tomato;"><strong>^</strong></span><span style="color: Tomato;"><strong>^</strong></span><span style="color: Tomato;"><strong>^</strong></span><span style="color: Tomato;"><strong>^</strong></span><span style="color: Tomato;"><strong>^</strong></span>
...
<pre class="language-text"><code class="language-text">React.createElement('div', {dangerouslySetInnerHTML: {__html: ''<span class="token variable">child</span><span class="token string">&apos;}})</span><strong><span style="background-color: red">child</span></strong></code></pre>
<pre class="language-text"><code class="language-text">React.createElement('div', {}, ''<span class="token variable">child</span><span class="token string">&apos;)</span><strong><span style="background-color: red">child</span></strong></code></pre>
...
<pre class="language-text"><code class="language-text">createElement('div', {dangerouslySetInnerHTML: {__html: ''<span class="token variable">child</span><span class="token string">&apos;}})</span><strong><span style="background-color: red">child</span></strong></code></pre>
<pre class="language-text"><code class="language-text">createElement('div', {}, ''<span class="token variable">child</span><span class="token string">&apos;)</span><strong><span style="background-color: red">child</span></strong></code></pre>
