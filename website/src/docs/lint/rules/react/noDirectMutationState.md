...
<pre class="language-text"><code class="language-text">
 ...
 <span style="text-decoration-style: dotted;">file.tsx:4:4</span> <strong>lint/react/noDirectMutationState</strong> ━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  <strong>  2</strong><strong> │ </strong>  testFunc() {
  <strong>  3</strong><strong> │ </strong>    this.state.person.name.first = &apos;bar&apos;;
  <strong><span style="color: Tomato;">&gt;</span></strong><strong> 4</strong><strong> │ </strong>    this.state.person.name.last = &apos;baz&apos;;
