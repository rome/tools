...
{% raw %}<pre class="language-text"><code class="language-text"><span style="color: Tomato;">error</span><span style="color: Tomato;">[</span><span style="color: Tomato;"><a href="https://rome.tools/docs/lint/rules/noDebugger/">correctness/noDebugger</a></span><span style="color: Tomato;">]</span><strong>: </strong><strong>This is an unexpected use of the </strong><strong><strong>debugger</strong></strong><strong> statement.</strong>
