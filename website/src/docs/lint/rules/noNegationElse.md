...
{% raw %}<pre class="language-text"><code class="language-text"><span style="color: Tomato;">error</span><span style="color: Tomato;">[</span><span style="color: Tomato;"><a href="https://rome.tools/docs/lint/rules/noNegationElse/">correctness/noNegationElse</a></span><span style="color: Tomato;">]</span><em>: </em><em>Invert blocks when performing a negation test.</em>
  <span style="color: rgb(38, 148, 255);">┌</span><span style="color: rgb(38, 148, 255);">─</span> correctness/noNegationElse.js:1:1
