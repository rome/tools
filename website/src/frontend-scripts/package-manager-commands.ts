...
const selectorButtons = document.querySelectorAll(".package-manager-selector li");
const elements = document.querySelectorAll(".package-manager-selector li, .package-manager-command");
