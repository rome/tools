			...
			<fieldset className="flex items-center">
				...
				<div className="relative flex items-start">
					<div>
						...
						<span id="source-type-description">
				...
				<div className="relative flex pb-0">
					<div className="flex items-center h-5">
						<input
							...
							className="focus:ring-indigo-500 h-4 w-4 border-gray-300 rounded disabled:opacity-30"
					...
					<div className="ml-1">
						...
						<span id="typescript-description">
							<span className="sr-only">TypeScript</span>
						</span>
					</div>
				</div>
				<div className="relative flex pl-1 pb-0">
					<div className="flex items-center h-5">
						<input
							id="jsx"
