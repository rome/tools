		...
		<div className="group p-0.5 rounded-lg flex bg-gray-200 mb-4 m-2 w-fit">
			<button
				...
				className={classNames(
					...
					treeStyle === TreeStyle.Json && "bg-white shadow-sm ring-1 ring-black ring-opacity-5",
				)}
			>
				<span
					className={classNames(
				...
				>
					<span
						className={classNames(
							"text-gray-900",
							treeStyle === TreeStyle.Json ? "text-gray-900" : "text-gray-600 group-hover:text-gray-900",
						)}
					>
						JSON
					</span>
			...
			<button
				...
				className={classNames(
					...
					treeStyle === TreeStyle.Text && "bg-white shadow-sm ring-1 ring-black ring-opacity-5",
				)}
			>
