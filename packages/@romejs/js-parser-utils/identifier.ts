...
export function isES2015ReservedWord(word: string): boolean {
...
export function getFullCharCodeAt(str: string, offset: number) {
...
export function isIdentifierStart(code: undefined | number): boolean {
	if (code === undefined) {
		return false;
	}
