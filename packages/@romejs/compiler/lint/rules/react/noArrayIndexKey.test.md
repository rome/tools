...
**DO NOT MODIFY**. This file has been autogenerated. Run `rome test packages/@romejs/compiler/lint/rules/react/noArrayIndexKey.test.ts --update-snapshots` to update.
