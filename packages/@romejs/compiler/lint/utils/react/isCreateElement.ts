import {AnyNode, JSCallExpression} from "@romejs/ast";
import {isIdentifierish, resolveIndirection} from "@romejs/js-ast-utils";
import {ImportBinding, Scope} from "@romejs/compiler";
