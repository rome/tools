...
test('numbers', t => {
  ...
  t.is(format(10), '10');
  t.is(format(100), '100');
  t.is(format(1000), '1_000');
  t.is(format(10000), '10_000');
  t.is(format(100000), '100_000');
  t.is(format(1000000), '1_000_000');
  t.is(format(10000000), '10_000_000');
  t.is(format(100000000), '100_000_000');
  t.is(format(1000000000), '1_000_000_000');
});
