...
**DO NOT MODIFY**. This file has been autogenerated. Run `rome test packages/@romejs/js-compiler/lint/rules/regular/restrictedGlobals.test.ts --update-snapshots` to update.
