...
**DO NOT MODIFY**. This file has been autogenerated. Run `rome test packages/@romejs/js-compiler/lint/rules/js/confusingLanguage.test.ts --update-snapshots` to update.
