...
**DO NOT MODIFY**. This file has been autogenerated. Run `rome test packages/@romejs/js-compiler/lint/rules/js/preferFunctionDeclarations.test.ts --update-snapshots` to update.
