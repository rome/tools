...
**DO NOT MODIFY**. This file has been autogenerated. Run `rome test packages/@romejs/js-compiler/transforms/lint/restrictedGlobals.test.ts --update-snapshots` to update.
