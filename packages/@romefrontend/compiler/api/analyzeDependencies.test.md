...
**DO NOT MODIFY**. This file has been autogenerated. Run `rome test packages/@romefrontend/compiler/api/analyzeDependencies.test.ts --update-snapshots` to update.
