...
## `experimental > template-literal-invalid-escapes-untagged > 44`
			...
			expression: JSTemplateLiteral {
				...
				quasis: [
					JSTemplateElement {
						...
						raw: "left"
						tail: false
						loc: SourceLocation experimental/template-literal-invalid-escapes-untagged/44/input.js 1:1-1:5
					}
					JSTemplateElement {
						cooked: "\\u{g}"
						raw: "\\u{g}"
						tail: false
						loc: SourceLocation experimental/template-literal-invalid-escapes-untagged/44/input.js 1:9-1:14
					}
					JSTemplateElement {
						cooked: "right"
						raw: "right"
...
```
 ...
 experimental/template-literal-invalid-escapes-untagged/44/input.js:1:10 parse(js) ━━━━━━━━━━━━━━━━━
