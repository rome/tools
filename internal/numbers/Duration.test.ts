...
test(
	...
	(t) => {
		...
		t.inlineSnapshot(Duration.fromMilliseconds(100_000_000).format(), "27h46m40s");
		...
		t.inlineSnapshot(Duration.fromMilliseconds(100_000).format(opts), "1m40.00s");
		t.inlineSnapshot(Duration.fromMilliseconds(1_000_000).format(opts), "16m40.00s");
		t.inlineSnapshot(Duration.fromMilliseconds(10_000_000).format(opts), "2h46m40.00s");
		t.inlineSnapshot(Duration.fromMilliseconds(100_000_000).format(opts), "27h46m40.00s");

		const longOpts = {longform: true};
		t.inlineSnapshot(Duration.fromMilliseconds(1).format(longOpts), "0.00 seconds ");
		t.inlineSnapshot(Duration.fromMilliseconds(10).format(longOpts), "0.01 seconds ");
		t.inlineSnapshot(Duration.fromMilliseconds(100).format(longOpts), "0.10 seconds ");
		t.inlineSnapshot(Duration.fromMilliseconds(1_000).format(longOpts), "1 second");
		t.inlineSnapshot(Duration.fromMilliseconds(10_000).format(longOpts), "10 seconds");
		t.inlineSnapshot(Duration.fromMilliseconds(100_000).format(longOpts), "1 minute 40 seconds");
		t.inlineSnapshot(
