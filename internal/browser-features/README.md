...
browser.getRawReleaseDate(); // => 1607990400 (can be undefined)

browser.getReleaseDate(); // => Date Mon Jan 19 1970 15:39:50 GMT+0100 (Central European Standard Time) (as a date object, can be undefined)
