...
/* GENERATED:START(hash:53420353f87b95ceb9fb371c9f03228256a6f835,id:main) Everything below is automatically generated. DO NOT MODIFY. Run `./rome run scripts/generated-files/ast` to update. */
...
import CSSCalcNumberProduct from "./css/calculations/CSSCalcNumberProduct";
builders.set("CSSCalcNumberProduct", CSSCalcNumberProduct);
import CSSCalcNumberSum from "./css/calculations/CSSCalcNumberSum";
builders.set("CSSCalcNumberSum", CSSCalcNumberSum);
import CSSCalcNumberValue from "./css/calculations/CSSCalcNumberValue";
builders.set("CSSCalcNumberValue", CSSCalcNumberValue);
import CSSCalcOperation from "./css/calculations/CSSCalcOperation";
builders.set("CSSCalcOperation", CSSCalcOperation);
import CSSCalcProduct from "./css/calculations/CSSCalcProduct";
builders.set("CSSCalcProduct", CSSCalcProduct);
import CSSCalcSum from "./css/calculations/CSSCalcSum";
builders.set("CSSCalcSum", CSSCalcSum);
import CSSCalcValue from "./css/calculations/CSSCalcValue";
...
import CSSComma from "./css/core/CSSComma";
builders.set("CSSComma", CSSComma);
import CSSCustomProperty from "./css/core/CSSCustomProperty";
builders.set("CSSCustomProperty", CSSCustomProperty);
...
import CSSGridAreaValue from "./css/grid/CSSGridAreaValue";
builders.set("CSSGridAreaValue", CSSGridAreaValue);
...
builders.set("CSSMediaFeatureEQ", CSSMediaFeatureEQ);
import CSSMediaFeatureGT from "./css/media/CSSMediaFeatureGT";
builders.set("CSSMediaFeatureGT", CSSMediaFeatureGT);
import CSSMediaFeatureLT from "./css/media/CSSMediaFeatureLT";
builders.set("CSSMediaFeatureLT", CSSMediaFeatureLT);
import CSSMediaFeatureName from "./css/media/CSSMediaFeatureName";
builders.set("CSSMediaFeatureName", CSSMediaFeatureName);
import CSSMediaFeaturePlain from "./css/media/CSSMediaFeaturePlain";
builders.set("CSSMediaFeaturePlain", CSSMediaFeaturePlain);
import CSSMediaFeatureRange from "./css/media/CSSMediaFeatureRange";
builders.set("CSSMediaFeatureRange", CSSMediaFeatureRange);
import CSSMediaFeatureValue from "./css/media/CSSMediaFeatureValue";
builders.set("CSSMediaFeatureValue", CSSMediaFeatureValue);
...
import CSSMinmaxFunction from "./css/grid/CSSMinmaxFunction";
builders.set("CSSMinmaxFunction", CSSMinmaxFunction);
...
import CSSRatio from "./css/core/CSSRatio";
